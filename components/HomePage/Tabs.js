...
export default function Tabs() {
  ...
  return (
    <div className="py-20" style={{ backgroundColor: "#F4F4FF" }}>
      <div className="w-11/12 mx-auto shadow-xl rounded-2xl py-20 bg-white  relative z-20 -top-96">
        <div className="lg:flex text-center lg:text-left lg:p-0 p-4">
          ...
          <div className="lg:w-2/5 ">
            ...
            <p>
              Execute purchasing requests front-to-end, based on the proprietary
              Lhotse multi-algorithm request assessment and automation engine.
              You are getting the best available sourcing options.
            </p>
          </div>
        </div>
